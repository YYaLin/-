...
``` python
每个方法清洗5轮，每轮10次，结果如下：
[Vanilla] 清洗前准确率: 0.6701
[Vanilla] 清洗后准确率: 0.6662
[Vanilla] 提升: -0.0039
[Vanilla] 各轮次准确率: [0.6523, 0.6787, 0.6645, 0.652, 0.6671]

[CoTeaching] 清洗前准确率: 0.8125
[CoTeaching] 清洗后准确率: 0.8090
[CoTeaching] 提升: -0.0035
[CoTeaching] 各轮次准确率: [0.81, 0.8051, 0.8005, 0.7993, 0.7961]

[ELR] 清洗前准确率: 0.6657
[ELR] 清洗后准确率: 0.6758
[ELR] 提升: 0.0101
[ELR] 各轮次准确率: [0.6596, 0.6537, 0.6505, 0.6705, 0.6496]

提升并不大甚至副作用，是要调参还是哪的问题
```